...
(4, 18, 6, '2022-12-04', 12, '2023-12-04'),
(5, 15, 6, '2022-11-11', 12, '2023-11-11');
...
CREATE TABLE `clients` (
  ...
  `no_of_subs` int(11) NOT NULL,
  `list_of_subs` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `contracts` (`id`, `contract_name`, `path`) VALUES
(2, '120922-contract-ptcobates', '120922-contract-ptcobates.pdf');
...
(6, 10, 7, '2022-01-01', 12, '2023-01-01'),
...
(29, 31, 9, '2022-08-23', 1, '2022-09-23');
...
(19, 24, '2022-06-30', 'Proposal Highly Sensitive Background Check sent.', 'Lee Bumgarner', 'GG'),
(20, 25, '2019-05-14', 'Proposal Information and Emergency Response Services sent.', 'Mauritz K', '-'),
(21, 26, '2022-07-12', 'Proposal Information Incident Tracking and Incident Cluster Mapping Services Phillipines sent.', 'check', '-'),
(22, 27, '2022-07-26', 'Prop submitted, waiting budget approval', 'Budiawansyah', 'GG'),
(23, 28, '2022-07-26', 'Vendor registration Forms to be completed', 'Steven Dunn', 'GG'),
(24, 29, '2022-08-04', 'NDA submitted', 'Karunia Gandhini', 'GG'),
(25, 30, '2022-09-06', 'Proposal word version for GG', '-', '-'),
(26, 31, '2022-09-06', 'NDA prep. Signed and sent.', '-', '-'),
(27, 32, '2022-09-16', 'Inquiry for info service subscription received', 'Dito Sutejo', '-'),
(28, 33, '2022-09-16', 'Inquiry for info service subscription received', 'Teguh Priyambodo - Sec Mgr Assistant', '-'),
(29, 34, '2022-09-19', 'Trial subscription activate', 'Ivan Winata', '-'),
(30, 32, '2022-09-20', 'Meeting set at Concord Office, at 1400', 'Dito Sutejo', '-'),
(31, 31, '2022-09-11', 'Materials received from David Edmonds', '-', '-'),
(32, 30, '2022-09-09', 'Proposal for Risk Assessment sent to Malcolm McCabe', '-', '-'),
(33, 30, '2022-09-20', 'Becca waiting response from Vale', '-', '-'),
(34, 29, '2022-08-04', 'Scope of work received', 'Karunia Gandhini', 'RD'),
(35, 28, '2022-08-01', 'NDA submitted', 'Shinta', '-'),
(36, 28, '2022-08-04', 'Awaiting signed proposal', 'Shinta', '-'),
(37, 28, '2022-09-09', 'Document tender received', '-', '-'),
(38, 28, '2022-09-19', 'Inquiry email sent: Scope of Work in partial; number of subscriber for info service', 'Ms. Anacoura', '-'),
(39, 27, '2022-08-05', 'Proposal for Risk Management Consultancy Services submitted', '-', 'GG'),
(40, 27, '2022-09-09', 'Vale procurement: negotiation stage', '-', '-'),
(41, 26, '2022-07-12', 'On hold', '-', '-'),
(42, 25, '2022-06-17', 'Ruby Sunarjo: The proposal related to this matter has submitted to internal stakeholders, I will update soon.', '-', '-'),
(43, 25, '2022-02-10', 'Proposal Master Consultancy Support services Indonesia sent.', '-', '-'),
(44, 25, '2022-02-18', 'Proposal information services sent.', '-', '-'),
(45, 25, '2022-05-18', 'The client has requested CC to submit an SPOA to conduct a discreet and highly sensitive background check on the individual of interest, who identity still confidential.', '-', 'GG');
...
(142, 28, 7, '2022-01-01', 'Exxon starts premium subscription'),
...
CREATE TABLE `proposals` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `proposal_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `proposals` (`id`, `proposal_name`, `path`) VALUES
(2, '1221222-buisnessplan-proposal', '1221222-buisnessplan-proposal.docx');
...
(24, 'Lee Bumgarner'),
(25, 'Frisian Flag Indonesia'),
(26, 'UNILEVER PHILIPPINES INC'),
(27, 'Vale Indonesia'),
(28, 'Fortescue'),
(29, 'Unilever Oleochemical'),
(30, 'Becca'),
(31, 'QMS Media Pty Ltd'),
(32, 'PT Sinar Prapanca'),
(33, 'PT Pertamina EP Cepu - JTB'),
(34, 'Pertamina HSE');
