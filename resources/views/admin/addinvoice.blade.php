            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ url('admin/storeinvoice') }}">
                        ...
                        <div class="row mb-3">
                            <label for="contract_no" class="col-md-4 col-form-label text-md-end">Invoice Date</label>
                            <div class="col-md-6">
                                <input type="date" class="form-control" name="tgl_invoice" value="<?php echo date('Y-m-d') ?>">
                            </div>
                        </div>
