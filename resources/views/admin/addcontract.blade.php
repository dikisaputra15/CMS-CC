        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-white">
                    <h3>Add Contract Document</h3>
                </div>
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ url('admin/storecontract') }}">
                        @csrf

                        <div class="row mb-3">
                            <label for="contract_no" class="col-md-4 col-form-label text-md-end">Contract Date</label>
                            <div class="col-md-6">
                                <input type="date" class="form-control" name="tgl_contract" value="<?php echo date('Y-m-d') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="contract" class="btn btn-danger">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
